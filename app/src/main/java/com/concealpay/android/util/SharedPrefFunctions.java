package com.concealpay.android.util;


import static com.concealpay.android.util.Constants.IS_PROMINENT_DISCLOSURE_AGREED;
...
public class SharedPrefFunctions {
    ...
    public void deletePref() {
        SharedPreferences.Editor ed = mSharedPreferences.edit();
        ed.clear();
        ed.putBoolean(IS_PROMINENT_DISCLOSURE_AGREED, true);
        ed.apply();
    }
}
